  ...
  return (
    <section className="flex flex-col h-screen lg:justify-end font-poppins">
      <div className="w-full bg-blue-900 pt-11 dark:bg-gray-900">
            ...
            <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
              ...
              <p className="flex items-center mb-4">
                <svg
                  ...
                  viewBox="0 0 16 16"
                >
                  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a11.785 11.785 0 0 0 6.158 6.158c.6.211 1.286.033 1.77-.45l1.035-1.035a.678.678 0 0 0 .063-1.015l-2.1-2.1a.678.678 0 0 0-.928-.062 8.789 8.789 0 0 1-3.827 3.828.678.678 0 0 0-.062.928l2.1 2.1a.678.678 0 0 0 1.015.063l1.035-1.035c.483-.484.661-1.169.45-1.77a11.785 11.785 0 0 0-6.158-6.158c-.6-.211-1.286-.033-1.77.45L1.328 3.654a.678.678 0 0 0-.063 1.015l2.1 2.1a.678.678 0 0 0 .928.062 8.789 8.789 0 0 1 3.827-3.828.678.678 0 0 0 .062-.928L3.654 1.328z"></path>
                </svg>
                <span className="text-gray-300 dark:text-gray-400">
                  +977 9876543210
                </span>
        ...
        <div className="flex justify-center py-2 text-gray-300 bg-blue-800 dark:bg-gray-800">
          <p className="text-sm">

...
export function About() {
  return (
    <div className="">
      <div className="relative  mb-32 isolate overflow-hidden py-24 sm:py-32">
        <img
          src={image}
          alt=""
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-Homemade font-bold tracking-tight text-white sm:text-6xl">
              Who are we
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              ...
              on a mission to build a business on a foundation of mutual trust
              and respect, we value our quality more than our profits
            </p>
          </div>
        </div>
      </div>
